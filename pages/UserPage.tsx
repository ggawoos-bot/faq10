...
const AccordionItem: React.FC<AccordionItemProps> = ({ faq, isOpen, onToggle, onFeedback, searchTerm }) => {
    ...
    <div className="border-b border-gray-200">
      <h2>
        <button
          ...
          onClick={onToggle}
        >
          <span className="flex-1 text-lg font-semibold">{highlightText(faq.question, searchTerm)}</span>
      ...
      {isOpen && (
        <div className="p-5 border-t border-gray-200 bg-white">
          <p className="mb-4 text-gray-600 leading-relaxed whitespace-pre-wrap">{highlightText(faq.answer, searchTerm)}</p>
