...
import { PlusIcon, SearchIcon, PencilIcon, TrashIcon, DocumentDownloadIcon } from '../components/icons';
import FaqFormModal from '../components/FaqFormModal';
import ConfirmationModal from '../components/ConfirmationModal';
import { exportFilteredToExcel } from '../utils/excelExport';
...
const AdminPage: React.FC<AdminPageProps> = ({ faqs, onAdd, onUpdate, onDelete }) => {
  ...
  const handleExportToExcel = () => {
    exportFilteredToExcel(filteredFaqs, searchTerm, filterCategory);
  };
